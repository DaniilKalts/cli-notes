...
**Description:** Generate SSH keys used for authentication, password-less logins, and other things. <br />
See also: `ssh-copy-id`. <br />
**More information:** https://man.openbsd.org/ssh-keygen. <br />
