...
**Description:** CLI for AWS S3 - provides storage through web services interfaces. <br />
Some subcommands such as `cp` have their own usage documentation. <br />
**More information:** https://docs.aws.amazon.com/cli/latest/reference/s3/. <br />
