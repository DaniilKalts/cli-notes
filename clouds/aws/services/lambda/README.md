...
**Description:** Use AWS Lambda, a compute service for running code without provisioning or managing servers. <br />
**More information:** https://docs.aws.amazon.com/cli/latest/reference/lambda/. <br />
